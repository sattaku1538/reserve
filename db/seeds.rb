...
# Product.create(name: 'cake1', discription: 'good', category_id: 1, is_sold: true, price: 500)
# Product.create(name: 'cake2', discription: 'good', category_id: 2, is_sold: true, price: 500)
